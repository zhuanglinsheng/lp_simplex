...
int simplex_tableau_create(double **table, int **basis, int **constraint_types,
...
void simplex_tableau_fill_constraint_types(
		const struct optm_LinearConstraint *constraints, int *types, int m);

void simplex_tableau_fill_constraints(
		double *table, int ld, const struct optm_LinearConstraint *constraints,
...
int simplex_tableau_add_slack(double *table, int ld, const int *types,
		int m, int n);

int simplex_tableau_add_artificial(double *table, int ld, const int *types,
		int m, int n, int slack_count);

void simplex_tableau_initialize_basis(int *basis, const int *types,
		int m, int n, int slack_count);
...
void simplex_tableau_remove_artificial_basis(
		double *table, int ld, int *basis, int m, int real_columns,
		int variable_count);

void simplex_tableau_remove_artificial_columns(
		double *table, int ld, int m, int real_columns, int artificial_count);
