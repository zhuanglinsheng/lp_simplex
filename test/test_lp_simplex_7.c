...
struct lp_simplex_LinearConstraint constraints[] = {
	{ "", constraint_1_coef,  3., lp_simplex_CONS_T_EQ },
	{ "", constraint_2_coef,  2., lp_simplex_CONS_T_EQ },
	{ "", constraint_3_coef, -5., lp_simplex_CONS_T_EQ },
	{ "", constraint_4_coef,  1., lp_simplex_CONS_T_EQ }
};
